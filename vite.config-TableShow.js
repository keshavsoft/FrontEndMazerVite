...
import sidebarItems from "./src-TableShow/sidebar-items.json"
import horizontalMenuItems from "./src-TableShow/horizontal-menu-items.json"

const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);

const root = resolve(__dirname, 'src-TableShow')
const CommonOutFolder = "PublicDir/TableShow";
