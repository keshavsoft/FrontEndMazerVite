...
import sidebarItems from "./src-Vertical/sidebar-items.json"
import horizontalMenuItems from "./src-Vertical/horizontal-menu-items.json"

const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);

const root = resolve(__dirname, 'src-Vertical')
const CommonOutFolder = "PublicDir/Vertical";
