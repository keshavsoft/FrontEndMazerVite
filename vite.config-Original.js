...
import sidebarItems from "./src-Original/sidebar-items.json"
import horizontalMenuItems from "./src-Original/horizontal-menu-items.json"

const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);

const root = resolve(__dirname, 'src-Original')
