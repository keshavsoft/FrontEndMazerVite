...
import sidebarItems from "./src-PublicDir/sidebar-items.json"
import horizontalMenuItems from "./src-PublicDir/horizontal-menu-items.json"

const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);

const root = resolve(__dirname, 'src-PublicDir')
const CommonOutFolder = "PublicDir/SubDir";
