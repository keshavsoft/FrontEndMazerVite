...
import sidebarItems from "./src-FromEntryVoucher/sidebar-items.json"
import horizontalMenuItems from "./src-FromEntryVoucher/horizontal-menu-items.json"

const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);

const root = resolve(__dirname, 'src-FromEntryVoucher')
const CommonOutFolder = "PublicDir/FromEntryVoucher";
