...
const srcFolder = "src_QrCode";
const distFolder = "publicDir/QrCode";

import sidebarItems from "./src_QrCode/sidebar-items.json";
import horizontalMenuItems from "./src_QrCode/horizontal-menu-items.json";
