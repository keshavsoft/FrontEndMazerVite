...
import sidebarItems from "./src-ToBranch/sidebar-items.json"
import horizontalMenuItems from "./src-ToBranch/horizontal-menu-items.json"

const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);

const root = resolve(__dirname, 'src-ToBranch')
const CommonOutFolder = "PublicDir/ToBranch";
