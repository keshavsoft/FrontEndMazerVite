...
import sidebarItems from "./src-Factory/sidebar-items.json"
import horizontalMenuItems from "./src-Factory/horizontal-menu-items.json"

const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);

const root = resolve(__dirname, 'src-Factory')
